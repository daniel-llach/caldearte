...
- \`runStartDate\`/\`runEndDate\`: interpreta el texto de fecha de la fuente y repórtalos en formato "YYYY-MM-DD". **Casi todos los ítems traen un texto de fecha real que interpretar — hazlo de forma activa, no los dejes en null por defecto.** Ejemplo real: el texto "11 jul de 2026 - 11 oct de 2026" se reporta como \`runStartDate: "2026-07-11"\`, \`runEndDate: "2026-10-11"\`. Usa null únicamente cuando el texto de fecha genuinamente no permite determinar esa parte (ej. solo dice "Vigente" sin fechas). Si el ítem dice explícitamente "Fechas de exhibición ya confirmadas: ..." al inicio, el código ya las tiene y usará esas en vez de lo que reportes aquí — puedes dejar ambos campos en null en ese caso específico, no importa.
